          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-orange-300">Name</h2>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-orange-300">Email</h2>
            ...
            <div className="bg-gray-700 p-6 rounded-lg">
              ...
              <Link className='block' to="/dashboard/options">
                ...
                <Link to="/dashboard/predictions" className='block'><button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded transition duration-300">
                  View Predictions
                </button></Link>
                <Link to="/dashboard/tips" className='block'><button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded transition duration-300">
                  Energy Saving Tips
                </button></Link>
                <Link to="/dashboard/analytics" className='block'><button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded transition duration-300">
                  View Analytics
                </button></Link>
              </div>
            </div>
