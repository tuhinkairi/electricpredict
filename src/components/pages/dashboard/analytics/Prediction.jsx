...
const Prediction = () => {
  ...
  const sendDataToServer = async (totalUsage) => {
    try {
      const response = await axios.post('http://127.0.0.1:5000/api/data', {
        user_input: totalUsage,
      });
  ...
  const  calculatePrediction = async () => {   
    ...
    // const acUsage = appliances.ac * 1.5 * 8 * 30; // Assuming 1500W AC used 8 hours a day
    // const waterHeaterUsage = appliances.waterHeater * 4.5 * 1 * 30; // Assuming 4500W water heater used 1 hour a day
    const totalPrediction =   await sendDataToServer(appliances);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-orange-300">Fan</h2>
                  <input
                    type="number"
                    name="lights"
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-orange-300">Refrigerator</h2>
                  <input
                    type="number"
                    name="tv"
                    value={appliances.tv}
