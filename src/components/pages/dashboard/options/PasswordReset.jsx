  ...
  return (
    <section id='passwordreset' className=" min-h-screen pt-24">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-6 text-center">Password Reset</h1>
          <div className="flex items-center space-x-4 mb-4">
            <FaLock className="text-orange-500 text-2xl" />
            <h2 className="text-xl font-semibold text-orange-300">Enter your email to reset your password</h2>
          </div>
