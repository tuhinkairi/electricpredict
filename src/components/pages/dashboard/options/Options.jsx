    ...
    <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900 min-h-screen pt-24">
      <div className="container mx-auto px-4">
        ...
        <Link to="/dashboard" className="absolute right-10 bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded transition duration-300">dashboard</Link>
          <h1 className="text-4xl font-bold text-white mb-6 text-center">Dashboard Options</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-orange-300">Account Settings</h2>
                  <Link to="/dashboard/options/profile" className="text-gray-300 hover:text-orange-400 transition-colors">
                    Edit Profile
                  </Link>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-orange-300">Notifications</h2>
                  <button 
                    onClick={toggleNotifications}
                    className={`text-gray-300 hover:text-orange-400 transition-colors ${notifications ? 'font-bold' : ''}`}
                  >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-orange-300">Security</h2>
            ...
            <div className="bg-gray-700 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <button className="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded transition duration-300 flex items-center justify-center">
